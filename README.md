...
The Marketing Performance Intelligence Dashboard is an interactive Tableau-powered analytics project designed to help marketing teams make data-driven decisions.
It tracks performance across multiple advertising platforms, identifies high-performing campaigns, and highlights opportunities to reallocate spend for maximum ROI.
...
We as a digital marketing agency manages multiple ad campaigns across Facebook, Google, and Instagram for a product line. Management wants to understand which platforms, campaigns, and audience segments yield the highest ROI, and how they can optimize budget allocation for future campaigns.

# Why The Need To Act

Marketing teams often know what they spend, but not what they earn back.
This dashboard reveals where the money is effective and where it is wasted, allowing decision-makers to focus every dollar on the channels that drive real business impact.

# Business Objectives

1. Identify which ad platform delivers the best ROI and conversion rate. 
2. Identify which campaigns perform best in terms of engagement and cost efficiency. 
3. Identify the regions and audience segments that are most responsive. 
4. Identify the ad format with the best engagement 
5. How can ad spend be reallocated to maximize ROI?
...
Out of every 100 users reached, about 3 click through, and only 0.45 ultimately convert; meaning 96.98% drop off before clicking and another 84.89% drop off before completing a purchase or sign-up.
This shows a strong top-of-funnel performance (great reach and awareness) but a leaky middle and bottom, where engagement and conversion fall sharply.
The data suggests that while your campaigns successfully capture attention, they struggle to sustain user interest through to action; likely due to weak targeting precision, poor follow-through, a misaligned ad-to-landing experience, or a lack of a clear conversion incentive.
The focus should shift from reach to resonance, ensuring each impression has a higher chance of turning into a conversion.
...
•	Microsoft, on the other hand, achieves the same conversion rate as Instagram but with a lower acquisition cost, meaning it turns clicks into customers more efficiently.
...
**Recommendations**
1.	Replicate High-ROI Strategies: Analyze what is driving performance (audience, creatives, timing) and replicate those factors across other campaigns.
2.	Leverage High Engagement Campaigns: Use high-engagement campaigns to drive top-of-funnel awareness and retarget engaged audiences with conversion-focused ads. Use their ad creatives, headlines, and messaging style.
3.	Optimize Cost-Efficient Campaigns: Enhance creative messaging and landing page experience for cost-efficient but low-performing campaigns to improve conversion value.
4.	Bridge the Gap Between Engagement and Profitability: Review landing page experience to ensure consistency between the ad message and landing offer. 
5.	Improve call-to-action clarity and page load speed to minimize drop-offs.
6.	Reallocate Budget Intelligently: Shift 15–20% of ad spend toward high-ROI campaigns (e.g., CPN-216, CPN-106) to maximize returns.
7.	Monitor and Test Continuously: Track CPA and ROI monthly, and A/B test creatives, audiences, and ad timing to sustain performance gains.
A strategic reallocation of budget, favoring proven high-return campaigns while optimizing underperformers, can drive sustained profitability without additional ad spend.
...
**Recommendations** 
1.	Prioritize Video Ads: Continue investing in video content, it delivers the highest conversion rate and balances engagement well.
2.	Refine Carousel Ads: Since carousels drive the highest engagement but lower conversions, improve calls-to-action and end-frame clarity to guide users to act.
3.	Optimize Image Ads: Maintain image ads for quick, high-performing conversions, especially in retargeting or remarketing campaigns.
4.	Rework Story Ads: Since Story ads underperform slightly, experiment with shorter storytelling, stronger CTAs, and audience segmentation to lift conversions.
